...
import { Card, List, Image, Tooltip, Typography, Modal } from 'antd';
import {
  EditOutlined,
  DeleteOutlined,
          ...
          <List.Item>
            <Card
              ...
              cover={<Image
                ...
                />}
              actions={[
                <Tooltip key="edit" title="编辑" onClick={() => EditHandle(item)}>
                  <EditOutlined />
                </Tooltip>,
                <Tooltip key="download" title="删除" onClick={() => DeleteHandle(item.id)}>
                  <DeleteOutlined />
                </Tooltip>
              ]}
            >
