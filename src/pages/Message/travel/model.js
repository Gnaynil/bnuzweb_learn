import { getDescribe, deleteActivity, getActivityRealnameList, getRegionList, getLabelList, getSubjectList, getItemActivityList } from './service';
import { message } from 'antd';
const Model = {
  namespace: 'listTravel',
  state: {
    listTravel: [],
    meta: {
      current: 1,
  ...
  reducers: {
    queryList(state, action) {
      return { ...state, listTravel: action.payload };
    },
